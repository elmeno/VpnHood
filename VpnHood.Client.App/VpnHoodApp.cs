...
namespace VpnHood.Client.App
{
  public class VpnHoodApp : IDisposable
  {
    ...
    public ResponseCode LastSessionStatusCode { get; private set; }
    ...
    private VpnHoodApp(IAppProvider clientAppProvider, AppOptions options = null)
    {
      ...
      Settings = new AppSettings().Load(Path.Combine(AppDataFolderPath, FILENAME_Settings));
    ...
    public AppState State => new()
    {
      ...
      SessionStatusCode = _hasConnectRequested ? LastSessionStatusCode : ResponseCode.Ok,
    ...
    public void ClearLastError()
    {
      ...
      LastException = null;
      LastSessionStatusCode = ResponseCode.Ok;
    ...
    public async Task Connect(Guid clientProfileId, bool diagnose = false, string userAgent = null)
    {
      ...
      catch (Exception ex)
      {
        ...
        if (!_hasDisconnectedByUser)
        {
          ...
          LastException = ex;
          LastSessionStatusCode = Client.SessionStatus.ResponseCode;
          Disconnect();
        }
        throw;
      }
