...
const messages = {
  en: {
    ...
    confirmRemoveServer:
      'Do you really want to remove this server?<br/><br/>{serverName}',
    addTestServer: 'Add public server',
    addTestServerSubtitle:
      'You have removed the Public Test Server. This server is free and for evaluation.',
    ...
    invalidAccessKeyFormat:
      'The accessKey has invalid format. make sure it starts with {prefix}',
    servers: 'Servers',
    selectServerTitle: 'Select or Add a server',
    publicServerWarningTitle: 'Public Server Hint',
    publicServerWarning:
      'It is a connection to public servers created for evaluation. It may be slow or not accessible sometimes.<br/><br/>To have a reliable and fast connection, you need to connect to Private Servers.',
    ...
    protocol_desc:
      'UDP is much faster for apps that heavily use it, such as torrents, but it may not work with some firewalls and proxies. If you disable UDP, all apps still work, but they may get much slower.',
